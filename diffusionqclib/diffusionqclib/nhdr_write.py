#!/usr/bin/env python
# This script is originally written in Python3
# https://github.com/pnlbwh/conversion/blob/master/conversion/nhdr_write.py
...
type: {}\ndimension: {}\nspace: right-anterior-superior'.format(numpy_to_nrrd_dtype[dtype.name],dim))
    ...
    if scl_slope!=1.0 or scl_inter!=0:
        ...
        print('old min: {}'.format(oldmin))
        print('old max: {}'.format(oldmax))
    ...
    if dim == 4:
        print('space directions: {} none'.format(matrix_string(spc_dir.T)))
